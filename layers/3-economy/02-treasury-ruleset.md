...
_<What constitutes treasury funds and which accounts are declared community treasury accounts — to be defined.>_
...
_<Current income sources and rule for approving new income interfaces — to be defined.>_
...
_<Accounting ledger requirements, roles for financial management, and reporting rules — to be defined.>_
...
_<Debt, long-term obligation, contingency reserve, and off-treasury instrument rules — to be defined.>_
...
_<Self-approval prohibition and conflict-of-interest disclosure requirements — to be defined.>_
