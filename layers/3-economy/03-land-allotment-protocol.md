...
:::rcos{clauses="5.1.1, 5.1.2, 5.1.4"}
:::

:::rationale{title="Why define the community area first?"}
...
_<Definition and boundaries of the community area — to be defined.>_

## Private Homestead Areas

:::rcos{clauses="5.1.1, 5.1.2, 5.4.1, 5.4.2"}
:::

:::rationale{title="Why separate private homesteads from shared land?"}
...
_<Private homestead area rights, limits, and trustee obligations — to be defined.>_
...
:::rationale{title="Why reserve land from use?"}
...
_<Nature reserve designation, boundaries, and use restrictions — to be defined.>_
