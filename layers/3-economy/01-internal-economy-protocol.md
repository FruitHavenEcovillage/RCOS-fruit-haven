...
_<What qualifies, how contributions are recorded, who validates, effect on access/privileges, and dispute process — to be defined.>_
...
_<Formal internal contribution-recognition unit — to be defined via future ratification.>_
...
_<Accumulation limits and decay mechanisms — to be defined.>_
...
_<Current income sources and rule for approving new external income interfaces — to be defined.>_
...
_<Dispute process for contribution records and internal unit balances — to be defined.>_
