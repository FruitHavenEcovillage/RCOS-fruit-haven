...
_<Rules for time-bounding, documenting, and reviewing temporary responsibilities — to be defined.>_
...
_<Meeting load, role load, response time expectations, and renegotiation process — to be defined.>_
...
_<Current state, handover mechanisms, and continuity review cadence — to be defined.>_
...
_<Access rules for governance decisions, meeting notes, membership state, and contribution records — to be defined.>_
...
|---|---|---|---|
| RCOS artifacts | `layers/` in this repo | _<to be defined>_ | Per change protocol (Layer 6) |
| _<other document types — to be defined>_ | | | |
