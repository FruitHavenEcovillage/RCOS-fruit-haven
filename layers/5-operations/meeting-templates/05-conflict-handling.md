...
- **Ladder step:**
- **Conflict class:**
- **Outcome:** Agreement reached / Escalated to next step / Adjourned (with date for next session)
- **Agreed actions (if any):** [List with owners and dates]
- **Escalation destination (if applicable):**
- **Access:** Parties and Facilitator only; disclosed to Full Members only if escalated to Step 5
