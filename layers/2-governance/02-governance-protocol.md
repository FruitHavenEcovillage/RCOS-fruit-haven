...
- **Strategic and Constitutional decisions:** Any Full Member may submit a proposal directly on Fruit Haven using the predefined proposal template (see [Missing Technical Implementations](../../resources/missing-technical-implementations.md))
...
- **Withdrawal:** A proposer may withdraw their proposal at any point before the Fruit Haven vote opens by notifying the community via Discord or forum. Once the vote has opened, withdrawal is not possible.

## Review and Deliberation

- Deliberation happens in the community forum (discussions.fruithaven.land) or Discord before and during the Fruit Haven vote window
...
- The Fruit Haven vote link is included in the proposal file as the decision record
...
- A re-vote is held using the same Fruit Haven mechanism and threshold as the original decision
...
- **Decision capture:** Fruit Haven voting is open to all Full Members simultaneously; no quorum requirement beyond votes cast (any participation level is valid)
