...
_<Consensus method, voting power rules, formal threshold, absentee review period, and informal decision process — to be defined.>_
...
- **Operational** — Day-to-day functioning within existing rules.
- **Strategic** — Long-term direction, significant resource allocation, creation or removal of major structures.
- **Constitutional** — Changes to Layer 0 or the governance system itself.
