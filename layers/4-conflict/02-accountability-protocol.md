...
_<Conditions that initiate an accountability check — to be defined.>_
...
_<Graduated response pathways by breach severity — to be defined.>_
...
Accountability without due process is just punishment with paperwork. A member facing a sanction needs to know the concern, have real time to respond, and have somewhere to appeal to — otherwise the Facilitator's word is final by default, which concentrates power exactly where it should not concentrate.
:::

_<Right to notice, prior warning, response time, appeal, and presence rules — to be defined.>_
...
_<Conditions for rights restoration after voluntary exit, forced exit, and temporary access restriction — to be defined.>_
...
All forced exits and temporary access restrictions must follow the Exit & Separation Protocol (Layer 1).
