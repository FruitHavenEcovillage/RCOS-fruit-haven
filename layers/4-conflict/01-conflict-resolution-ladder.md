...
:::rationale{title="Why classify conflicts at all?"}
...
|---|---|---|---|---|
| **Interpersonal** | Member-to-member friction, communication issues, personal disagreements | Step 1 | _<to be defined>_ | _<to be defined>_ |
| **Role-based** | Disputes about how a role was performed, task scope disagreements | Step 2 | _<to be defined>_ | _<to be defined>_ |
| **Structural** | Disputes about whether a governance process was followed correctly | Step 2 | _<to be defined>_ | _<to be defined>_ |
| **Ethical / obligation breach** | Breach of Membership Agreement obligations or Layer 0 principles (non-severe) | Step 3 | _<to be defined>_ | _<to be defined>_ |
| **Safety-critical** | Credible safety risk, coercion, abuse, or threats | Step 4 (bypasses Steps 1–3) | _<to be defined>_ | _<to be defined>_ |
...
:::rationale{title="Why a stepped ladder instead of a single process?"}
...
_<Resolution ladder steps — to be defined.>_

## Emergency Safety Protocol

_<Emergency safety protocol for immediate physical harm, violence, coercion, or abuse — to be defined.>_
...
:::rationale{title="What stops a process from being killed by silence?"}
...
_<Non-response, withdrawal, and deadlock handling — to be defined.>_
...
:::rationale{title="Why name how the Facilitator is chosen or replaced?"}
...
_<Facilitator selection, conflict-of-interest replacement, and external facilitation options — to be defined.>_
...
:::rationale{title="Why bound information flow so tightly?"}
...
_<Confidentiality scope, record retention, and non-disclosure rules — to be defined.>_
...
:::rationale{title="Why do safeguards exist on top of the ladder?"}
...
_<Anti-retaliation, bad-faith complaint, facilitator conflict, process pause, and power-differential safeguards — to be defined.>_
