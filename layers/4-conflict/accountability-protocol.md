...
- **Right to appeal:** Any Admin decision may be appealed to Full Members via the governance process (Strategic vote)
...
|---|---|---|---|
| Private check-in / reminder | Inactivity or minor breach | Admin | Yes — to Full Members |
| Written warning | Unresolved obligation breach after check-in | Admin | Yes — to Full Members |
| Temporary access restriction | Safety-critical situation only; must be reviewed within 14 days | Admin | Yes — to Full Members |
...
- **After temporary access restriction:** rights restored upon Admin confirmation of resolution (within 14 days of restriction being imposed)
