...
Identity constraints may only be added, modified, or removed through a Constitutional decision, as defined in the Decision Matrix (Layer 2) and the Change Protocol (Layer 6). Any change must be recorded in the Version History (Layer 6).
