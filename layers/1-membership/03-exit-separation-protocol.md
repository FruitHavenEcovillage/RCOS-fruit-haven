...
_<Voluntary exit process and access revocation timeline — to be defined.>_
...
_<Forced exit process, notification requirements, and re-application block — to be defined.>_
...
_<Formal membership suspension — to be defined.>_
...
_<Separation steps applying to both voluntary and forced exits — to be defined.>_
