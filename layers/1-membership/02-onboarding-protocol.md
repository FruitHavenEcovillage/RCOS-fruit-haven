...
_<Admission criteria — to be defined.>_
...
_<Onboarding steps — to be defined.>_
...
:::rationale{title="Why assign a state at the end of onboarding?"}
...
_<Initial membership state on approval and on completion — to be defined.>_
...
_<Trial period duration, evaluation criteria, transition and failure conditions — to be defined.>_
...
_<How and where onboarding completion is recorded — to be defined.>_
