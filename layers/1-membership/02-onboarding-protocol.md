...
7. _Members with voting power must consult the "New Member Expectations" list (consented to by the Fruit Haven community in 2018, referred to in the [FH1 Bylaws](/source-documents/FH1_Community_Bylaws.pdf) as the "List of Expectations for a New Community Member") and use it to guide the admission decision._
