...
Ideas and deferred decisions that are not yet technically feasible, not yet prioritised, or intentionally set aside for a later phase. Items here are candidates for future governance proposals once the conditions for implementation are met.

Priorities: **High** — address soon; **Medium** — important but not urgent; **Low** — nice to have.
