...
- Layer 0 - `layers/0-identity/01-purpose-charter.md` (Art. 2: non-profit purpose and vision)
- Layer 0 - `layers/0-identity/02-scope-declaration.md` (Art. 1: community name; Art. 2.03: vision statement)
- Layer 0 - `layers/0-identity/03-invariants-register.md` (Art. 12: rights of community members)
- Layer 0 - `layers/0-identity/04-identity-constraints-register.md` (Art. 10: ethics and lifestyle constraints — veganism, raw foods, no domesticated animals, nudism, personal hygiene, substance policy)
- Layer 1 - `layers/1-membership/01-membership-agreement.md` (Art. 8: residency rules; Art. 13: ratification and signature requirement)
- Layer 1 - `layers/1-membership/04-membership-state-registry.md` (Art. 8.02: five classes of persons — trustees, volunteers, community residents, community members, guests)
- Layer 2 - `layers/2-governance/01-decision-matrix.md` (Art. 11.03–11.04: jurisdiction of decisions; unanimity-minus-one rule for expulsion; trustee authority over property-value and legal-risk decisions)
- Layer 2 - `layers/2-governance/02-governance-protocol.md` (Art. 11.01–11.02: consensus decision-making process; voting power requirements; community meeting procedures and minutes)
- Layer 2 - `layers/2-governance/04-federation-protocol.md` (Art. 6.02: hierarchy of governing documents — community bylaws subordinate to Sovereignty Doctrine, Trustee Bylaws, and Trustee Legal Contract)
- Layer 3 - `layers/3-economy/02-treasury-ruleset.md` (Art. 9: community fund establishment and public accounting requirements)
- Layer 3 - `layers/3-economy/03-land-allotment-protocol.md` (Art. 7: community area, private homestead areas, and nature reserve definitions)
- Layer 5 - `layers/5-operations/02-role-registry.md` (Art. 3–4: committees and officer positions; Volunteer Program Coordinator role)
- Layer 6 - `layers/6-evolution/01-change-protocol.md` (Art. 5: periodic decentralization review; Art. 6.01: bylaws amendment by unanimous vote of voting-power members)
